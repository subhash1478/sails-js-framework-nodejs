...
__.extend(RouteTable.prototype, {
  ...
  get: function get__1(resourceGroupName, routeTableName, _) { var self, progress, routeTable, __this = this; var __frame = { name: "get__1", line: 30 }; return __func(_, this, arguments, get__1, 2, __frame, function __$get__1() { self = __this;

      progress = self.interaction.progress(util.format($("Looking up Route Table \"%s\""), routeTableName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$get__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$get__1() {
                  ...
                  return self.networkManagementClient.routeTables.get(resourceGroupName, routeTableName, null, __cb(_, __frame, 4, 64, function ___(__0, __1) { routeTable = __1;
                    return _(null, routeTable); }, true)); }); })(function ___(e, __result) { __catch(function __$get__1() { if (e) {
