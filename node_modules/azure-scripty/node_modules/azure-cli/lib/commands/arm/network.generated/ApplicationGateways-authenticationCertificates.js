        ...
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                authenticationCertificate = utils.findFirstCaseIgnore(parentItem.authenticationCertificates, { name: name });
                if (authenticationCertificate) {
                  return _(new Error(util.format($("authentication certificate with name \"%s\" already exists in application gateway \"%s\""), name, gatewayName))); } ;


                parameters = { }; return (function __$__1(__then) {
                  ...
                  progress = cli.interaction.progress(util.format($("Creating authentication certificate in application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                        return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 50, 73, function ___(__0, __5) { applicationGateway = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {

                          progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__1() {


                      parentItem = applicationGateway;
                      cli.interaction.formatOutput(utils.findFirstCaseIgnore(parentItem.authenticationCertificates, { name: name }), generatorUtils.traverse); _(); }); }); }); }); }); }, true)); }, true)); }, true)); }); });


  authenticationCertificates.command("set [resource-group] [gateway-name] [name]").description($("Update an authentication certificate")).usage("[options] <resource-group> <gateway-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-n, --name <name>", $("the name of the authentication certificate")).option("-f, --cert-file [cert-file]", $("sets authentication certificates name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, gatewayName, name, options, _) { var subscription, networkManagementClient, applicationGateway, progress, parentItem, authenticationCertificate, parameters, data; var __frame = { name: "__2", line: 115 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                authenticationCertificate = utils.findFirstCaseIgnore(parentItem.authenticationCertificates, { name: name });
                if (!authenticationCertificate) {
                  return _(new Error(util.format($("authentication certificate with name \"%s\" not found in application gateway \"%s\""), name, gatewayName))); } ;


                parameters = authenticationCertificate; return (function __$__2(__then) {
                  ...
                  generatorUtils.removeEmptyObjects(parameters);
                  progress = cli.interaction.progress(util.format($("Updating authentication certificate in \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                        return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 47, 73, function ___(__0, __5) { applicationGateway = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __3) { gatewayName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                index = utils.indexOfCaseIgnore(parentItem.authenticationCertificates, { name: name });
                if ((index === -1)) {
                  return _(new Error(util.format($("authentication certificate \"%s\" not found in application gateway \"%s\""), name, gatewayName))); } ; return (function __$__3(_) {


                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete authentication certificate with name \"%s\" from application gateway \"%s\"? [y/n] "), name, gatewayName), __cb(_, __frame, 32, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -178, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) { return _(null); } else { __then(); } ; })(function __$__3() {



                    parentItem.authenticationCertificates.splice(index, 1);

                    progress = cli.interaction.progress("Deleting authentication certificate"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
