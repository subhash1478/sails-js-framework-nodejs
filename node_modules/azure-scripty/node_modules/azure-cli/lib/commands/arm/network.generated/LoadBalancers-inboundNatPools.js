...
exports.init = function(cli) {
  ...
  var inboundNatPools = loadBalancers.category("inbound-nat-pool").description($("Commands to manage inbound nat pools"));
  ...
  inboundNatPools.command("create [resource-group] [lb-name] [name]").description($("Create an inbound nat pool")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat pool")).option("-i, --frontend-ip-name [frontend-ip-name]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-id"))).option("-d, --frontend-ip-id [frontend-ip-id]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-name"))).option("-p, --protocol [protocol]", $(("the transport protocol for the" + "\n     endpoint. Possible values are 'Udp' or 'Tcp' or 'All.'"))).option("-f, --frontend-port-range-start [frontend-port-range-start]", $((("the first port number in the range of" + "\n     external ports that will be used to provide Inbound Nat to NICs associated with") + "\n     a load balancer. Acceptable values range between 1 and 65534"))).option("-e, --frontend-port-range-end [frontend-port-range-end]", $((("the last port number in the range of" + "\n     external ports that will be used to provide Inbound Nat to NICs associated with") + "\n     a load balancer. Acceptable values range between 1 and 65535"))).option("-b, --backend-port [backend-port]", $(("the port used for internal connections" + "\n     on the endpoint. Acceptable values are between 1 and 65535"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, lbName, name, options, _) { var useDefaults, subscription, networkManagementClient, loadBalancer, progress, parentItem, inboundNatPool, parameters, referredFrontendIPConfiguration, idContainerFrontendIPConfiguration; var __frame = { name: "__1", line: 66 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 3, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 4, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                inboundNatPool = utils.findFirstCaseIgnore(parentItem.inboundNatPools, { name: name });
                if (inboundNatPool) {
                  return _(new Error(util.format($("inbound nat pool with name \"%s\" already exists in load balancer \"%s\""), name, lbName))); } ;
                ...
                if (options.frontendPortRangeStart) {
                  parameters.frontendPortRangeStart = parseInt(options.frontendPortRangeStart, 10); } else {
                  if (useDefaults) {
                    parameters.frontendPortRangeStart = parseInt(defaultFrontendPortRangeStart, 10); } ; } ;


                if (options.frontendPortRangeEnd) {
                  parameters.frontendPortRangeEnd = parseInt(options.frontendPortRangeEnd, 10); } else {
                  if (useDefaults) {
                ...
                progress = cli.interaction.progress(util.format($("Creating inbound nat pool in load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                      return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, lbName, loadBalancer, __cb(_, __frame, 88, 61, function ___(__0, __5) { loadBalancer = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {

                        progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__1() {


                    parentItem = loadBalancer;
                    cli.interaction.formatOutput(utils.findFirstCaseIgnore(parentItem.inboundNatPools, { name: name }), generatorUtils.traverse); _(); }); }); }); }); }, true)); }, true)); }, true)); }); });


  inboundNatPools.command("set [resource-group] [lb-name] [name]").description($("Update an inbound nat pool")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat pool")).option("-i, --frontend-ip-name [frontend-ip-name]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-id"))).option("-d, --frontend-ip-id [frontend-ip-id]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-name"))).option("-p, --protocol [protocol]", $(("the transport protocol for the" + "\n     endpoint. Possible values are 'Udp' or 'Tcp' or 'All.'"))).option("-f, --frontend-port-range-start [frontend-port-range-start]", $((("the first port number in the range of" + "\n     external ports that will be used to provide Inbound Nat to NICs associated with") + "\n     a load balancer. Acceptable values range between 1 and 65534"))).option("-e, --frontend-port-range-end [frontend-port-range-end]", $((("the last port number in the range of" + "\n     external ports that will be used to provide Inbound Nat to NICs associated with") + "\n     a load balancer. Acceptable values range between 1 and 65535"))).option("-b, --backend-port [backend-port]", $(("the port used for internal connections" + "\n     on the endpoint. Acceptable values are between 1 and 65535"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, lbName, name, options, _) { var useDefaults, subscription, networkManagementClient, loadBalancer, progress, parentItem, inboundNatPool, parameters, referredFrontendIPConfiguration, idContainerFrontendIPConfiguration; var __frame = { name: "__2", line: 184 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 3, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 4, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                inboundNatPool = utils.findFirstCaseIgnore(parentItem.inboundNatPools, { name: name });
                if (!inboundNatPool) {
                  return _(new Error(util.format($("inbound nat pool with name \"%s\" not found in load balancer \"%s\""), name, lbName))); } ;


                parameters = inboundNatPool;
                ...
                generatorUtils.removeEmptyObjects(parameters);
                progress = cli.interaction.progress(util.format($("Updating inbound nat pool in \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                      return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, lbName, loadBalancer, __cb(_, __frame, 79, 61, function ___(__0, __5) { loadBalancer = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
  ...
  inboundNatPools.command("delete [resource-group] [lb-name] [name]").description($("Delete an inbound nat pool")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat pool")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, parentItem, index; var __frame = { name: "__3", line: 280 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __3) { lbName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                index = utils.indexOfCaseIgnore(parentItem.inboundNatPools, { name: name });
                if ((index === -1)) {
                  return _(new Error(util.format($("inbound nat pool \"%s\" not found in load balancer \"%s\""), name, lbName))); } ; return (function __$__3(_) {


                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete inbound nat pool with name \"%s\" from load balancer \"%s\"? [y/n] "), name, lbName), __cb(_, __frame, 32, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -279, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) { return _(null); } else { __then(); } ; })(function __$__3() {



                    parentItem.inboundNatPools.splice(index, 1);

                    progress = cli.interaction.progress("Deleting inbound nat pool"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
  ...
  inboundNatPools.command("show [resource-group] [lb-name] [name]").description($("Show an inbound nat pool")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat pool")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, parentItem, inboundNatPool; var __frame = { name: "__4", line: 333 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {
                ...
                cli.interaction.formatOutput(inboundNatPool, generatorUtils.traverse); _(); }); }); }, true)); }, true)); }, true)); }); });


  inboundNatPools.command("list [resource-group] [lb-name]").description($("List inbound nat pools")).usage("[options] <resource-group> <lb-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, lbName, options, _) { var subscription, networkManagementClient, loadBalancer, progress, parentItem; var __frame = { name: "__5", line: 374 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
