...
exports.init = function(cli) {
  ...
  var parametersCreateOrUpdateImagesOsDisk1SPoD1 = catparametersCreateOrUpdateImagesOsDisk1SPoD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesOsDisk1SPoD1 = parametersCreateOrUpdateImagesOsDisk1SPoD1.category("os-disk").description($("Commands to configure os-disk of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesOsDisk1SPoD1.command("delete").description($("Remove os-disk in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"osDisk\" : {\r\n             \"osType\":\"\",\r\n             \"osState\":\"\",\r\n             \"snapshot\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"managedDisk\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"blobUri\":\"\",\r\n             \"caching\":null,\r\n             \"diskSizeGB\":null,\r\n             \"storageAccountType\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--os-type", $("Remove the os-type value.")).option("--os-state", $("Remove the os-state value.")).option("--snapshot", $("Remove the snapshot value.")).option("--managed-disk", $("Remove the managed-disk value.")).option("--blob-uri", $("Remove the blob-uri value.")).option("--caching", $("Remove the caching value.")).option("--disk-size-g-b", $("Remove the disk-size-g-b value.")).option("--storage-account-type", $("Remove the storage-account-type value.")).execute(function __11(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__11", line: 992 }; return __func(_, this, arguments, __11, 1, __frame, function __$__11() {
      ...
      return cli.output.verbose(JSON.stringify(options), __cb(_, __frame, 1, 15, function __$__11() { return (function __$__11(__then) {
          ...
          options.operation = "remove";
          options.path = "/storageProfile/osDisk";
          anySubItem = ((((((((false || options.osType) || options.osState) || options.snapshot) || options.managedDisk) || options.blobUri) || options.caching) || options.diskSizeGB) || options.storageAccountType);
          if (anySubItem) {
            subItemPath = null;
            if (options.osType) {
  ...
  var parametersCreateOrUpdateImagesSnapshot0SPoDs1 = catparametersCreateOrUpdateImagesSnapshot0SPoDs1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var setparametersCreateOrUpdateImagesSnapshot0SPoDs1 = parametersCreateOrUpdateImagesSnapshot0SPoDs1.category("snapshot").description($("Commands to configure snapshot of managed-image in config file."));

  setparametersCreateOrUpdateImagesSnapshot0SPoDs1.command("set").description($("Set snapshot in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"snapshot\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--id <id>", $("Set the id value.")).execute(function __12(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__12", line: 1069 }; return __func(_, this, arguments, __12, 1, __frame, function __$__12() {
  ...
  var parametersCreateOrUpdateImagesSnapshot1SPoDs1 = catparametersCreateOrUpdateImagesSnapshot1SPoDs1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesSnapshot1SPoDs1 = parametersCreateOrUpdateImagesSnapshot1SPoDs1.category("snapshot").description($("Commands to configure snapshot of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesSnapshot1SPoDs1.command("delete").description($("Remove snapshot in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"snapshot\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--id", $("Remove the id value.")).execute(function __13(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__13", line: 1121 }; return __func(_, this, arguments, __13, 1, __frame, function __$__13() {
  ...
  var parametersCreateOrUpdateImagesManagedDisk0SPoDmD1 = catparametersCreateOrUpdateImagesManagedDisk0SPoDmD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var setparametersCreateOrUpdateImagesManagedDisk0SPoDmD1 = parametersCreateOrUpdateImagesManagedDisk0SPoDmD1.category("managed-disk").description($("Commands to configure managed-disk of managed-image in config file."));

  setparametersCreateOrUpdateImagesManagedDisk0SPoDmD1.command("set").description($("Set managed-disk in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"managedDisk\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--id <id>", $("Set the id value.")).execute(function __14(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__14", line: 1170 }; return __func(_, this, arguments, __14, 1, __frame, function __$__14() {
  ...
  var parametersCreateOrUpdateImagesManagedDisk1SPoDmD1 = catparametersCreateOrUpdateImagesManagedDisk1SPoDmD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesManagedDisk1SPoDmD1 = parametersCreateOrUpdateImagesManagedDisk1SPoDmD1.category("managed-disk").description($("Commands to configure managed-disk of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesManagedDisk1SPoDmD1.command("delete").description($("Remove managed-disk in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"managedDisk\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--id", $("Remove the id value.")).execute(function __15(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__15", line: 1222 }; return __func(_, this, arguments, __15, 1, __frame, function __$__15() {
  ...
  var parametersCreateOrUpdateImagesDataDisks0SPdD1 = catparametersCreateOrUpdateImagesDataDisks0SPdD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var setparametersCreateOrUpdateImagesDataDisks0SPdD1 = parametersCreateOrUpdateImagesDataDisks0SPdD1.category("data-disks").description($("Commands to configure data-disks of managed-image in config file."));

  setparametersCreateOrUpdateImagesDataDisks0SPdD1.command("set").description($("Set data-disks in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"dataDisks\" : {\r\n             \"lun\":\"\",\r\n             \"snapshot\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"managedDisk\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"blobUri\":\"\",\r\n             \"caching\":null,\r\n             \"diskSizeGB\":null,\r\n             \"storageAccountType\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--lun <lun>", $("Set the lun value.")).option("--snapshot <snapshot>", $("Set the snapshot value.")).option("--managed-disk <managedDisk>", $("Set the managed-disk value.")).option("--blob-uri <blobUri>", $("Set the blob-uri value.")).option("--caching <caching>", $("Set the caching value.")).option("--disk-size-g-b <diskSizeGB>", $("Set the disk-size-g-b value.")).option("--storage-account-type <storageAccountType>", $("Set the storage-account-type value.")).execute(function __16(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__16", line: 1279 }; return __func(_, this, arguments, __16, 1, __frame, function __$__16() {
  ...
  var parametersCreateOrUpdateImagesDataDisks1SPdD1 = catparametersCreateOrUpdateImagesDataDisks1SPdD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesDataDisks1SPdD1 = parametersCreateOrUpdateImagesDataDisks1SPdD1.category("data-disks").description($("Commands to configure data-disks of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesDataDisks1SPdD1.command("delete").description($("Remove data-disks in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"dataDisks\" : {\r\n             \"lun\":\"\",\r\n             \"snapshot\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"managedDisk\":{\r\n               \"id\":\"\"\r\n             },\r\n             \"blobUri\":\"\",\r\n             \"caching\":null,\r\n             \"diskSizeGB\":null,\r\n             \"storageAccountType\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--lun", $("Remove the lun value.")).option("--snapshot", $("Remove the snapshot value.")).option("--managed-disk", $("Remove the managed-disk value.")).option("--blob-uri", $("Remove the blob-uri value.")).option("--caching", $("Remove the caching value.")).option("--disk-size-g-b", $("Remove the disk-size-g-b value.")).option("--storage-account-type", $("Remove the storage-account-type value.")).execute(function __17(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__17", line: 1408 }; return __func(_, this, arguments, __17, 1, __frame, function __$__17() {
      ...
      return cli.output.verbose(JSON.stringify(options), __cb(_, __frame, 1, 15, function __$__17() { return (function __$__17(__then) {
          ...
          options.operation = "remove";
          options.path = ("/storageProfile/dataDisks" + ((options.index ? (("/" + options.index)) : "")));
          anySubItem = (((((((false || options.lun) || options.snapshot) || options.managedDisk) || options.blobUri) || options.caching) || options.diskSizeGB) || options.storageAccountType);
          if (anySubItem) {
            subItemPath = null;
            if (options.lun) {
  ...
  var parametersCreateOrUpdateImagesSnapshot0SPdDDIs1 = catparametersCreateOrUpdateImagesSnapshot0SPdDDIs1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var setparametersCreateOrUpdateImagesSnapshot0SPdDDIs1 = parametersCreateOrUpdateImagesSnapshot0SPdDDIs1.category("data-disks-snapshot").description($("Commands to configure data-disks-snapshot of managed-image in config file."));

  setparametersCreateOrUpdateImagesSnapshot0SPdDDIs1.command("set").description($("Set data-disks-snapshot in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"snapshot\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--data-disks-index <data-disks-index>", $("Indexer: data-disks-index.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--id <id>", $("Set the id value.")).execute(function __18(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__18", line: 1482 }; return __func(_, this, arguments, __18, 1, __frame, function __$__18() {
  ...
  var parametersCreateOrUpdateImagesSnapshot1SPdDDIs1 = catparametersCreateOrUpdateImagesSnapshot1SPdDDIs1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesSnapshot1SPdDDIs1 = parametersCreateOrUpdateImagesSnapshot1SPdDDIs1.category("data-disks-snapshot").description($("Commands to configure data-disks-snapshot of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesSnapshot1SPdDDIs1.command("delete").description($("Remove data-disks-snapshot in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"snapshot\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--data-disks-index <data-disks-index>", $("Indexer: data-disks-index.")).option("--id", $("Remove the id value.")).execute(function __19(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__19", line: 1535 }; return __func(_, this, arguments, __19, 1, __frame, function __$__19() {
  ...
  var parametersCreateOrUpdateImagesManagedDisk0SPdDDImD1 = catparametersCreateOrUpdateImagesManagedDisk0SPdDDImD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var setparametersCreateOrUpdateImagesManagedDisk0SPdDDImD1 = parametersCreateOrUpdateImagesManagedDisk0SPdDDImD1.category("data-disks-managed-disk").description($("Commands to configure data-disks-managed-disk of managed-image in config file."));

  setparametersCreateOrUpdateImagesManagedDisk0SPdDDImD1.command("set").description($("Set data-disks-managed-disk in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"managedDisk\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--data-disks-index <data-disks-index>", $("Indexer: data-disks-index.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--id <id>", $("Set the id value.")).execute(function __20(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__20", line: 1585 }; return __func(_, this, arguments, __20, 1, __frame, function __$__20() {
  ...
  var parametersCreateOrUpdateImagesManagedDisk1SPdDDImD1 = catparametersCreateOrUpdateImagesManagedDisk1SPdDDImD1.category("config").description($("Commands to manage configuration of images in the parameter file."));

  var deleteparametersCreateOrUpdateImagesManagedDisk1SPdDDImD1 = parametersCreateOrUpdateImagesManagedDisk1SPdDDImD1.category("data-disks-managed-disk").description($("Commands to configure data-disks-managed-disk of managed-image in config file."));

  deleteparametersCreateOrUpdateImagesManagedDisk1SPdDDImD1.command("delete").description($("Remove data-disks-managed-disk in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"managedDisk\" : {\r\n             \"id\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--data-disks-index <data-disks-index>", $("Indexer: data-disks-index.")).option("--id", $("Remove the id value.")).execute(function __21(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__21", line: 1638 }; return __func(_, this, arguments, __21, 1, __frame, function __$__21() {
  ...
  var imagesDelete = cli.category("managed-image").description($("Commands to manage your images.  "));

  imagesDelete.command("delete [resource-group] [name]").description($("Deletes an Image.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __22(resourceGroup, name, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__22", line: 1689 }; return __func(_, this, arguments, __22, 3, __frame, function __$__22() { return (function __$__22(__then) {
        ...
        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__22(__then) {
          ...
          subscription = profile.current.getSubscription(options.subscription);
          computeManagementClient = utils.createComputeManagementClient(subscription);
          return computeManagementClient.images.deleteMethod(resourceGroup, name, __cb(_, __frame, 13, 48, function ___(__0, __3) { result = __3;
            if (result) {
              cli.output.json(result); } ; _(); }, true)); }); }); }); });
  ...
  var imagesGet = cli.category("managed-image").description($("Commands to manage your images.  "));

  imagesGet.command("show [resource-group] [name] [expand]").description($("Gets an image.")).usage("[options] <resource-group> <name> <expand>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("--expand <expand>", $("expand")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __23(resourceGroup, name, expand, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__23", line: 1722 }; return __func(_, this, arguments, __23, 4, __frame, function __$__23() { return (function __$__23(__then) {
        ...
        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__23(__then) {
          ...
          cli.output.verbose(("name = " + name)); return (function __$__23(__then) {
            if (!expand) {
              return cli.interaction.promptIfNotGiven($("expand : "), expand, __cb(_, __frame, 12, 31, function ___(__0, __3) { expand = __3; __then(); }, true)); } else { __then(); } ; })(function __$__23() {


            cli.output.verbose(("expand = " + expand));
            subscription = profile.current.getSubscription(options.subscription);
            computeManagementClient = utils.createComputeManagementClient(subscription);
            return computeManagementClient.images.get(resourceGroup, name, expand, __cb(_, __frame, 18, 48, function ___(__0, __4) { result = __4;
  ...
  var imagesListByResourceGroup = cli.category("managed-image").description($("Commands to manage your images.  "));

  imagesListByResourceGroup.command("list [resource-group]").description($("Gets the list of images under a resource group.")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __24(resourceGroup, options, _) { var subscription, computeManagementClient, result, nextPageLink, pageResult; var __frame = { name: "__24", line: 1759 }; return __func(_, this, arguments, __24, 2, __frame, function __$__24() {
      ...
      subscription = profile.current.getSubscription(options.subscription);
      computeManagementClient = utils.createComputeManagementClient(subscription);
      result = null; return (function __$__24(__then) {
        if (utils.stringIsNullOrEmpty(resourceGroup)) {
          return computeManagementClient.images.list(__cb(_, __frame, 6, 46, function ___(__0, __1) { result = __1; __then(); }, true)); } else {


          return computeManagementClient.images.listByResourceGroup(resourceGroup, __cb(_, __frame, 9, 46, function ___(__0, __2) { result = __2; __then(); }, true)); } ; })(function __$__24() {

        nextPageLink = result.nextLink; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__24() { __more = false;
            var __6 = nextPageLink; if (__6) {
              return computeManagementClient.images.listByResourceGroupNext(nextPageLink, __cb(_, __frame, 13, 54, function ___(__0, __3) { pageResult = __3;
                pageResult.forEach(function(item) {
                  result.push(item); });

                nextPageLink = pageResult.nextLink; while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__24() {
